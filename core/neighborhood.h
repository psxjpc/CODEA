...
class neighborhood
{
   ...
   protected:
      ...
      */
      std::vector<agent*>* const getAgents() const;
   ...
   public:
      ...
      */
      virtual std::vector<agent*>* const list() const = 0;
...
std::vector<agent*>* const neighborhood::getAgents() const
{
   return this->agents;
}
